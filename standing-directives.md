The guide's content and design requirements live in style-guide.md. Any work producing or changing guide content must read that file first.

This repo's project-specific additions beyond the standard five files (per global-rules.md's allowance) are: style-guide.md, CONTENT.md, and STAGE3_CONTENT.md.
