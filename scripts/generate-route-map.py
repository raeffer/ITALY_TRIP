...
DAY1 = {
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 45.8015364,
            "lon": 11.9143170,
            "address": "Via Robert Browning 165, 31011 Asolo TV, Italy",
            "type": "Lunch",
            "color": ROUTE_ALTERNATIVE,
            "cluster": "asolo",
        },
    ...
    "poi_verification": {
        ...
        15: "Official Osteria al Bacaro contact page confirms Via Robert Browning 165; coordinates are the mapped arrival on that short street.",
        ...
        20: "Official Hotel Villa I Pini site confirms Via Schio 77; independent accommodation mapping and OpenStreetMap reverse data agree on the hotel entrance at Via Pini.",
...
DAY2 = {
    ...
    "poi_clusters": {
        "bassano": {
            "anchor": "Bassano",
            "numbers": [5, 6, 7, 8, 9, 10, 11, 12, 22, 23],
            "grid_offset": (40, -260),
            "columns": 3,
            "x_step": 66,
            "y_step": 58,
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 45.7686415,
            "lon": 11.7346900,
            "address": "Piazzetta Zaine 14/15, 36061 Bassano del Grappa VI, Italy",
            "type": "Pastry",
            "color": ROUTE_PRIMARY,
            "cluster": "bassano",
        },
        ...
        },
        {
            ...
            "lat": 45.63781,
            "lon": 11.78814,
            "address": "Via Muri Bianchi 35, 35013 Cittadella PD, Italy",
            "type": "Food stop",
            "color": ROUTE_PRIMARY,
            "cluster": "cittadella",
        },
        ...
        },
        {
            ...
            "lat": 45.231831,
            "lon": 11.462482,
            "address": "Via Circonvallazione 145, 35044 Montagnana PD, Italy",
        ...
        },
        {
            ...
            "lat": 44.7159632,
            "lon": 11.2364802,
            "address": "Via delle Rose 2A, San Matteo della Decima, 40017, Italy",
            "type": "Accommodation",
            "color": MARKER_ACCOMMODATION,
            "offset": (70, -60),
        },
        {
            ...
            "lat": 44.6287343,
            "lon": 11.1831380,
            "address": "Via Bassa 1F, 40017 San Giovanni in Persiceto BO, Italy",
            "type": "Accommodation / alternate",
            "color": MARKER_ACCOMMODATION,
            "offset": (-80, 30),
        },
        ...
        {
            "number": 23,
            "name": "Pasticceria Bolcato",
            "lat": 45.7564002,
            "lon": 11.7483555,
            "address": "Via Portile 12, 36061 Bassano del Grappa VI, Italy",
            "type": "Pastry producer / verify retail access",
            "color": ROUTE_PRIMARY,
            "cluster": "bassano",
        },
    ],
    "poi_verification": {
        ...
        10: "Official Danieli contact page confirms Piazza Garibaldi 39; coordinates are from the named OpenStreetMap venue node.",
        11: "Address and coordinates independently verified for Osteria Alla Caneva at Via Giacomo Matteotti 34.",
        12: "Official Dolce Bassano contact page confirms Piazzetta Zaine 14/15; coordinates are from the named OpenStreetMap venue node. Pasticceria Bolcato is a separate business at Via Portile 12 and is not merged into this pin.",
        ...
        14: "Current business and Waze listings agree on Via Muri Bianchi 35; independent business mapping supplies the storefront coordinate.",
        ...
        17: "Official Le Mura site confirms Via Circonvallazione 145; coordinate independently published by The Land of Venice tourism mapping.",
        18: "Coordinates from OpenStreetMap Nominatim for Antica Trattoria Bonasoni, Via Cento, San Matteo della Decima.",
        19: "Official L'Ulivo B&B site confirms Via delle Rose 2A; coordinate remains the mapped arrival on this short residential street.",
        20: "Official Boutique Hotel San Giovanni site confirms Via Bassa 1F; coordinates are from the exact OpenStreetMap house-number node.",
        ...
        23: "Official Pasticceria Bolcato site gives Via Portile 12, separate from Dolce Bassano; coordinate is the mapped Via Portile arrival because no exact public storefront node is indexed. Confirm retail access before making the detour.",
    },
}
...
DAY3 = {
    ...
    "pois": [
        ...
        {
            "number": 5,
            "name": "Magic Pasticcio",
            "lat": 44.6411217,
            "lon": 11.1866698,
            "address": "Via IV Novembre 21, 40017 San Giovanni in Persiceto BO, Italy",
        ...
        },
        {
            ...
            "lat": 44.4772540,
            "lon": 11.0095052,
            "address": "Via Giuseppe Garibaldi 1/N, 41058 Vignola MO, Italy",
    ...
    "poi_verification": {
        ...
        5: "The former Caffe Pasticceria Mimi premises were demolished in 2017, so this stop now uses Magic Pasticcio, a current Africanetto di Persiceto De.Co. producer; coordinates are the OpenStreetMap house-number node for its independently confirmed Via IV Novembre 21 address.",
        6: "Coordinates from OpenStreetMap Nominatim for Piazza dei Contrari 4 (Rocca di Vignola building footprint).",
        7: "Visit Vignola confirms Via Giuseppe Garibaldi 1/N; coordinates are from the named OpenStreetMap venue node.",
...
DAY7 = {
    ...
    "places": {
        ...
        "Pesce Palombo": (42.2619012, 14.5017989),
    },
    "routes": {
        "recommended": {
            "color": ROUTE_PRIMARY,
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 42.2619012,
            "lon": 14.5017989,
            "address": "SS16 Adriatica km 486.6, 66022 Fossacesia CH, Italy",
            "type": "Optional food stop",
            "color": ROUTE_OPTIONAL,
            "offset": (0, 46),
        },
    ...
    "poi_verification": {
        ...
        12: "Costa dei Trabocchi local tourism gives SS16 km 486.6 and 42.261855, 14.501858; coordinate refined to the named OpenStreetMap Trabocco Pesce Palombo structure.",
...
DAY10 = {
    ...
    "places": {
        ...
        "Foresta Umbra": (41.8168528, 15.9919951),
    },
    "routes": {
        "umbra": {
            "color": ROUTE_ALTERNATIVE,
    ...
    "pois": [
        ...
        {
            "number": 15,
            "name": "Foresta Umbra Visitor Center",
            "lat": 41.8168528,
            "lon": 15.9919951,
            "address": "SP52bis, Foresta Umbra, 71037 Monte Sant'Angelo FG, Italy",
    ...
    "poi_verification": {
        ...
        9: "Official Donlù site confirms Largo Seggio 8; coordinate is the Via Seggio/Largo Seggio arrival published by Italian cadastral street mapping, replacing the incorrect castle pin.",
        ...
        11: "Coordinates are from the named OpenStreetMap Box 19 venue node on Via Santa Maria di Merino.",
        12: "Official Dimora del Dragone site confirms Via Duomo 8 and the on-site restaurant; coordinates are the centre of the exact OpenStreetMap house-number building.",
        13: "Official property site confirms Via Duomo 8 and hosts Rosa and Pasquale; coordinates are the centre of the exact OpenStreetMap house-number building. Same building as Ristorante Al Dragone (POI 12).",
        ...
        15: "Broad forest centroid replaced with the practical Foresta Umbra Visitor Center arrival, confirmed by official Puglia tourism and the named OpenStreetMap visitor-centre node.",
    },
}
...
DAY12 = {
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 41.7073478,
            "lon": 15.9556536,
            "address": "Via Bartolomeo Gambadoro 3, 71037 Monte Sant'Angelo FG, Italy",
            "type": "Lunch / alternate",
            "color": ROUTE_PRIMARY,
            "cluster": "santangelo",
        },
        ...
        },
        {
            ...
            "lat": 41.2015560,
            "lon": 16.6046338,
            "address": "Via Alfredo Baccarini 4, 70056 Molfetta BA, Italy",
            "type": "Dinner / budget",
            "color": ROUTE_ALTERNATIVE,
            "cluster": "molfetta",
        },
        {
            ...
            "lat": 41.206260,
            "lon": 16.598270,
            "address": "Vico Campanile 4-6, 70056 Molfetta BA, Italy",
    ...
    "poi_verification": {
        ...
        5: "Comune and current restaurant sources confirm Via del Castello 21; GPS independently published by ViaggiamoHG and cross-checked against the old-town street layout.",
        6: "Official Al Barone site confirms Via Bartolomeo Gambadoro 3; coordinates are from the named OpenStreetMap restaurant node.",
        7: "Current listings confirm Via Reale Basilica 51; coordinates are from the named OpenStreetMap restaurant node.",
        ...
        11: "Resolved via OpenStreetMap Nominatim to the Duomo di San Corrado on Vico Campanile, used as the Molfetta old-town/overnight anchor; the nearby Il Mulino di Amleto is separately pinned at Vico Campanile 4-6.",
        12: "Official Dentro Le Mura site confirms Corso Dante 42; independent business mapping supplies the arrival coordinate, cross-checked against the mapped Corso Dante segment.",
        13: "Official La Cucina del Mare site confirms Via Baccarini 4; independent business mapping supplies the storefront coordinate.",
        14: "Municipal accommodation records confirm Vico Campanile 4-6; independent accommodation mapping supplies the building coordinate.",
        ...
        20: "Official Bari Vecchia Dimora site confirms Corte Lamberti 6; two independent accommodation maps agree on the building coordinate.",
    },
}
...
DAY13 = {
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 40.7292479,
            "lon": 17.5759763,
            "address": "Vico Giuseppe Ferrari 6, 72017 Ostuni BR, Italy",
            "type": "Food stop",
            "color": ROUTE_PRIMARY,
            "cluster": "ostuni",
        },
    ...
    "poi_verification": {
        ...
        8: "Italia.it and regional records confirm Via Giuseppe Garibaldi 44; two independent GPS sources agree within metres on the storefront coordinate.",
        ...
        10: "Official Forno 31 site and current listings confirm Vico Giuseppe Ferrari 6; coordinate is the OpenStreetMap lane centre beside the storefront, replacing the old-town centroid.",
        ...
        14: "Official and current independent listings confirm Via Mesagne 136; coordinates come from the listing's live directions destination, replacing the former street-segment approximation.",
    },
}
...
DAY14 = {
    ...
    "poi_verification": {
        ...
        5: "Address confirmed via the parish's own site; coordinates are the centre of the named OpenStreetMap church building.",
        6: "Address and storefront coordinate independently published by current business mapping, cross-checked against Via Monte San Michele.",
        ...
        13: "Official business site and multiple food sources confirm Via Giuseppe Garibaldi 4-6; two independent GPS sources agree within metres on the storefront coordinate.",
...
DAY15 = {
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 40.7416096,
            "lon": 17.4264336,
            "address": "Piazza Vittorio Emanuele II 5, 72014 Cisternino BR, Italy",
            "type": "Coffee",
            "color": ROUTE_PRIMARY,
            "cluster": "cisternino",
        },
        ...
        },
        {
            ...
            "lat": 40.74298,
            "lon": 17.42575,
            "address": "Via Domenico Cirillo 214, 72014 Cisternino BR, Italy",
            "type": "Dinner / alternate",
            "color": ROUTE_PRIMARY,
            "cluster": "cisternino",
        },
        {
            ...
            "lat": 40.717613,
            "lon": 17.403449,
            "address": "Contrada Portarino 10, 72017 Ostuni BR, Italy",
            "type": "Hidden gem / quirky",
            "color": ROUTE_ALTERNATIVE,
            "offset": (-90, 70),
        },
    ...
    "poi_verification": {
        ...
        4: "Official Bar FOD site confirms Piazza Vittorio Emanuele II 5; coordinates are from the named OpenStreetMap venue node.",
        ...
        7: "Current company records identify Itria Carni di Santoro at Via Domenico Cirillo 214; independent business mapping supplies the arrival coordinate.",
        8: "Official Bhole Baba foundation confirms Contrada Portarino 10, Ostuni; the Festival dei Sensi venue map supplies the rural entrance coordinate.",
    },
}
...
DAY17 = {
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 40.35565,
            "lon": 18.16858,
            "address": "Via Giuseppe Palmieri 91, 73100 Lecce LE, Italy",
            "type": "What to buy",
            "color": ROUTE_PRIMARY,
            "cluster": "lecce",
        },
    ...
    "poi_verification": {
        ...
        10: "Visit Lecce confirms the workshop at Via Giuseppe Palmieri 91; coordinate is the address-level arrival near the north end of the mapped street, replacing the incorrect Piazza Duomo pin.",
...
DAY19 = {
    ...
    "pois": [
        ...
        },
        {
            ...
            "lat": 40.647666,
            "lon": 17.519114,
            "address": "Largo Celso 4, 72013 Ceglie Messapica BR, Italy",
    ...
    "poi_verification": {
        ...
        6: "Current restaurant sources confirm Via Orto del Capitolo 10; coordinates are from the named OpenStreetMap restaurant node.",
        7: "Current restaurant and Accademia Italiana della Cucina sources confirm Largo Celso 4 (correcting 'Gelso'); coordinates are from the named OpenStreetMap venue data.",
        ...
        16: "Gambero Rosso and current listings confirm Via Niccolò Tommaso d'Aquino 8; coordinates are from the named OpenStreetMap restaurant node.",
    },
}
